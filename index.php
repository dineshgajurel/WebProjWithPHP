...
<div id="body">
    	...
    	<div class="header">
       		...
       		<div>
            <?php 
			$hsql="select *from gallery where status='1' and imgtype='normal' order by postdate desc";
			$hquery=mysql_query($hsql);
			$images = array();
			while($hd = mysql_fetch_array($hquery)){
				$image = "admin/images/gallery/".$hd['picture'];
				$images[] = $image;
			}
...
slideshowimages("images/dinesh/csit/1.jpg","images/dinesh/csit/2.jpg")
slideshowlinks("gallery.php","gallery.php","gallery.php","gallery.php","gallery.php")
...
//-->
				...
				<div class="section">
                   ...
                   <span>&#8220;The CSIT Activity Club is the club of CSIT students of Patan Multiple Campus in Patan Dhoka, Lalitpur. It founded in 2013.The club is run entirely by CSIT Students with a distinguished board of executives, advisors and general members overseeing club operations. It plans and organizes the overall activities of Computer Science and Information Technology.</span>
					...
					<a href="aboutus.php" title="About us" class="first">Learn More About Us</a>
