...
$ppath="images/gallery/";


  //to create new
  if(isset($_POST['create'])){
	   $imgtype= mysql_real_escape_string($_POST['imgtype']);
	  ...
	  $sql="insert into $type (title,url,summary,imgtype,picture,status) values('$title','$url','$summary','$imgtype','$pic','$status')";
  ...
  if(isset($_POST['change'])){
	  ...
	  if(!empty($url) && !empty($title)){
		$sql = "UPDATE $type SET title = '$title', url = '$url', summary= '$summary', imgtype='$imgtype', picture =                         '$pic', status = '$status' WHERE id = '$id' ";
		$query=mysql_query($sql);
	   if($query){
